...
export async function PATCH(req:Request){
 ...
 const allowedKeys=["name","phone","email","dest","destination","value","branch","source","priority","notes","status","salesperson","travel_date","travellers","follow_up","assigned_to"];
 ...
 if(ctx.session.profile.role!=="admin"){delete patch.salesperson;delete patch.assigned_to;}
