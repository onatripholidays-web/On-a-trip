...
export async function GET(req:Request){
 ...
 const r=await fetch(url+"/rest/v1/crm_lead_activities?select=*&enquiry_id=eq."+encodeURIComponent(id)+"&order=created_at.desc",{headers:{apikey:key,Authorization:"Bearer "+service},cache:"no-store"});
