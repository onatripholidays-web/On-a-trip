...
export async function POST(req:Request){
 ...
 const lead=await rest(url,key,"enquiries?id=eq."+encodeURIComponent(id),{method:"PATCH",headers:{Prefer:"return=representation"},body:JSON.stringify({assigned_to:userId,salesperson:personName,owner_user_id:userId})});
