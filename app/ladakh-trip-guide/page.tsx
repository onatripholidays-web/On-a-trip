...
export const metadata: Metadata = {
  title: "Ladakh Trip Guide: Best Time, Places, Route & Packing List | On A Trip Holidays",
  description: "A practical Leh Ladakh travel guide covering acclimatisation, Nubra, Pangong, Khardung La, best months and what to pack.",
  alternates: { canonical: "/ladakh-trip-guide" },
  robots: { index: true, follow: true, "max-image-preview": "large" },
  openGraph: {
    title: "Ladakh Trip Guide: Best Time, Places, Route & Packing List | On A Trip Holidays",
    description: "A practical Leh Ladakh travel guide covering acclimatisation, Nubra, Pangong, Khardung La, best months and what to pack.",
    url: "/ladakh-trip-guide",
