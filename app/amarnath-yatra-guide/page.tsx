...
export const metadata: Metadata = {
  title: "Amarnath Yatra Guide: Preparation, Route & Travel Tips | On A Trip Holidays",
  description: "Understand Amarnath Yatra planning, route choices, weather, registration considerations and preparation before travelling.",
  alternates: { canonical: "/amarnath-yatra-guide" },
  robots: { index: true, follow: true, "max-image-preview": "large" },
  openGraph: {
    title: "Amarnath Yatra Guide: Preparation, Route & Travel Tips | On A Trip Holidays",
    description: "Understand Amarnath Yatra planning, route choices, weather, registration considerations and preparation before travelling.",
    url: "/amarnath-yatra-guide",
