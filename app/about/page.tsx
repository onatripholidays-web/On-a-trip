...
export const metadata: Metadata = {
  title: "About On A Trip Holidays | Telugu Travel Company",
  description: "On A Trip Holidays is a travel company serving Telangana and Andhra Pradesh with Telugu-first support for pilgrimage, domestic, adventure and international holidays.",
...
export default function Page() {
  return (
    <SitePage>
      <nav className="nav"><a className="brand" href="/"><img alt="On A Trip Holidays" src="assets/logo.png" /></a><div className="navlinks"><a href="/packages">Packages</a><a href="/pilgrimage">Pilgrimage</a><a href="/itineraries">Itineraries</a><a href="packages.html#batches">Batches</a><a href="/blogs">Blogs</a><a href="blogs.html#new-destination-guides">Guides</a><a href="/about">About</a><a href="/contact">Contact</a></div><a className="wa" href="https://wa.me/919182894146?text=Hi%20On%20A%20Trip%20Holidays%2C%20I%20want%20a%20travel%20quote">WhatsApp Us</a></nav><section className="hero"><div className="hero-inner"><div className="eyebrow">About On A Trip Holidays</div><h1>Journeys made personal.</h1><p>We plan pilgrimage, domestic, adventure and international journeys with a strong focus on Telugu traveller support, comfortable logistics and responsive service.</p></div></section><section className="section"><div className="why"><div>🕉️<b>Pilgrimage specialists</b><p>Dedicated temple and yatra planning.</p></div><div>🏔️<b>Adventure circuits</b><p>Spiti, Ladakh, Kashmir and mountain routes.</p></div><div>✈️<b>International holidays</b><p>Thailand, Bali, Dubai, Nepal and more.</p></div><div>📲<b>Easy communication</b><p>WhatsApp-first enquiry and support.</p></div></div></section><div aria-label="Go to top" className="v18-page-top"><button aria-label="Go to top" type="button">⌃</button></div>
