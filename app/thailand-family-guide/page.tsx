...
export const metadata: Metadata = {
  title: "Thailand Family Trip Guide: Bangkok, Pattaya & Phuket | On A Trip Holidays",
  description: "A practical Thailand family travel guide covering itinerary planning, sightseeing, hotel areas and trip pacing.",
  alternates: { canonical: "/thailand-family-guide" },
  robots: { index: true, follow: true, "max-image-preview": "large" },
  openGraph: {
    title: "Thailand Family Trip Guide: Bangkok, Pattaya & Phuket | On A Trip Holidays",
    description: "A practical Thailand family travel guide covering itinerary planning, sightseeing, hotel areas and trip pacing.",
    url: "/thailand-family-guide",
