...
export const metadata: Metadata = {
  title: "Nepal & Muktinath Travel Guide: Route & Planning Tips | On A Trip Holidays",
  description: "Plan Kathmandu, Pokhara and Muktinath with route guidance, travel time, altitude considerations and useful preparation tips.",
  alternates: { canonical: "/nepal-muktinath-guide" },
  robots: { index: true, follow: true, "max-image-preview": "large" },
  openGraph: {
    title: "Nepal & Muktinath Travel Guide: Route & Planning Tips | On A Trip Holidays",
    description: "Plan Kathmandu, Pokhara and Muktinath with route guidance, travel time, altitude considerations and useful preparation tips.",
    url: "/nepal-muktinath-guide",
