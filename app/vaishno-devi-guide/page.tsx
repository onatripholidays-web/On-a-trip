...
export const metadata: Metadata = {
  title: "Vaishno Devi Yatra Guide: Katra, Route & Travel Tips | On A Trip Holidays",
  description: "Plan a Vaishno Devi pilgrimage with Katra stay options, route information and practical preparation tips.",
  alternates: { canonical: "/vaishno-devi-guide" },
  robots: { index: true, follow: true, "max-image-preview": "large" },
  openGraph: {
    title: "Vaishno Devi Yatra Guide: Katra, Route & Travel Tips | On A Trip Holidays",
    description: "Plan a Vaishno Devi pilgrimage with Katra stay options, route information and practical preparation tips.",
    url: "/vaishno-devi-guide",
