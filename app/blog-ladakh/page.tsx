...
export default function Page() {
  return (
    <SitePage>
      <nav className="nav"><a className="brand" href="/"><img alt="On A Trip Holidays" src="assets/logo.png" /></a><div className="navlinks"><a href="/packages">Packages</a><a href="/pilgrimage">Pilgrimage</a><a href="/itineraries">Itineraries</a><a href="packages.html#batches">Batches</a><a href="/blogs">Blogs</a><a href="blogs.html#new-destination-guides">Guides</a><a href="/about">About</a><a href="/contact">Contact</a></div><a className="wa" href="https://wa.me/919182894146?text=Hi%20On%20A%20Trip%20Holidays%2C%20I%20want%20a%20travel%20quote">WhatsApp Us</a></nav><section className="hero"><div className="hero-inner"><div className="eyebrow">Adventure</div><h1>Ladakh Trip Guide for First-Time Travellers</h1><p>Leh, Nubra, Pangong and acclimatisation basics for your first Ladakh adventure.</p></div></section><section className="section"><div className="form"><h2>Ladakh Trip Guide for First-Time Travellers</h2><p>Leh, Nubra, Pangong and acclimatisation basics for your first Ladakh adventure. This article can be expanded by the admin with day-wise routes, inclusions, hotel options, FAQs and booking information.</p><h3>Plan your trip</h3><p>Share your dates, number of travellers and departure city. Our team will suggest the best available batch or a private itinerary.</p><a className="btn" href="contact.html?package=ladakh">Get Package Quote</a></div></section><div aria-label="Go to top" className="v18-page-top"><button aria-label="Go to top" type="button">⌃</button></div>
