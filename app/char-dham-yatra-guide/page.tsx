...
export const metadata: Metadata = {
  title: "Char Dham Yatra Guide: Route, Days, Travel Tips & Preparation | On A Trip Holidays",
  description: "Plan Char Dham Yatra with a clear route, day-wise planning approach, stay expectations, walking preparation and useful travel tips.",
  alternates: { canonical: "/char-dham-yatra-guide" },
  robots: { index: true, follow: true, "max-image-preview": "large" },
  openGraph: {
    title: "Char Dham Yatra Guide: Route, Days, Travel Tips & Preparation | On A Trip Holidays",
    description: "Plan Char Dham Yatra with a clear route, day-wise planning approach, stay expectations, walking preparation and useful travel tips.",
    url: "/char-dham-yatra-guide",
...
export default function Page() {
  return (
    <SitePage>
      <nav className="nav"><a className="brand" href="/"><img alt="On A Trip Holidays" src="assets/logo.png" /></a><div className="navlinks"><a href="/packages">Packages</a><a href="/pilgrimage">Pilgrimage</a><a href="/itineraries">Itineraries</a><a href="packages.html#batches">Batches</a><a href="/blogs">Blogs</a><a href="blogs.html#new-destination-guides">Guides</a><a href="/about">About</a><a href="/contact">Contact</a></div><a className="wa" href="https://wa.me/919182894146?text=Hi%20On%20A%20Trip%20Holidays%2C%20I%20want%20a%20travel%20quote">WhatsApp Us</a></nav><main className="seo-article"><div className="eyebrow">ON A TRIP TRAVEL GUIDE</div><h1>Char Dham Yatra Guide: Route, Days, Travel Tips & Preparation</h1><p className="lead">Plan Char Dham Yatra with a clear route, day-wise planning approach, stay expectations, walking preparation and useful travel tips.</p><h2>Why plan this destination carefully?</h2><p>Char Dham can be enjoyed in very different ways depending on season, traveller profile, route and available time. Instead of packing every attraction into one schedule, build a practical plan with realistic travel time, comfortable stays and enough flexibility for local conditions.</p><h2>What to include in your itinerary</h2><ul><li>Choose the right arrival and departure point.</li><li>Keep daily driving and sightseeing realistic.</li><li>Confirm hotel location and room category before booking.</li><li>Check meals, transfers, entry tickets and optional activities.</li><li>Keep a buffer for weather, traffic and local operating conditions.</li></ul><h2>Best for</h2><p>Families, couples, friends and private groups can customise the route according to comfort, budget and interests.</p><h2>Before you book</h2><p>Travel conditions can change. Final hotels, vehicle category, meal plan, permits and departure timings should always be confirmed in the final booking voucher.</p><div className="v29-cta"><div><span>PLAN YOUR CHAR DHAM</span><h3>Get a customised itinerary from On A Trip Holidays.</h3><p>Tell us your travel date, number of travellers and preferred budget.</p></div><div><a className="btn" href="/contact">Get Quote</a><a className="btn light" href="https://wa.me/919182894146?text=Hi%20On%20A%20Trip%20Holidays%2C%20I%20want%20a%20custom%20Char Dham%20trip">WhatsApp</a></div></div></main><div aria-label="Go to top" className="v18-page-top"><button aria-label="Go to top" type="button">⌃</button></div>
