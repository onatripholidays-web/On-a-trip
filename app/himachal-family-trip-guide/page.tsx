...
export const metadata: Metadata = {
  title: "Himachal Family Trip Guide: Shimla, Manali & Kasol | On A Trip Holidays",
  description: "How to plan a comfortable Himachal family holiday with practical sightseeing, travel time and hotel planning.",
  alternates: { canonical: "/himachal-family-trip-guide" },
  robots: { index: true, follow: true, "max-image-preview": "large" },
  openGraph: {
    title: "Himachal Family Trip Guide: Shimla, Manali & Kasol | On A Trip Holidays",
    description: "How to plan a comfortable Himachal family holiday with practical sightseeing, travel time and hotel planning.",
    url: "/himachal-family-trip-guide",
