...
export const metadata: Metadata = {
  title: "Best Time to Visit Kashmir: Month-by-Month Guide | On A Trip Holidays",
  description: "Learn the best time to visit Kashmir for snow, flowers, sightseeing and family holidays, plus practical tips for Srinagar, Gulmarg and Pahalgam.",
  alternates: { canonical: "/best-time-visit-kashmir" },
  robots: { index: true, follow: true, "max-image-preview": "large" },
  openGraph: {
    title: "Best Time to Visit Kashmir: Month-by-Month Guide | On A Trip Holidays",
    description: "Learn the best time to visit Kashmir for snow, flowers, sightseeing and family holidays, plus practical tips for Srinagar, Gulmarg and Pahalgam.",
    url: "/best-time-visit-kashmir",
