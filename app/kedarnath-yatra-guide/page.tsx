...
export const metadata: Metadata = {
  title: "Kedarnath Yatra Guide: Route, Best Time & Travel Tips | On A Trip Holidays",
  description: "A practical Kedarnath Yatra guide covering route planning, accommodation, weather, walking and preparation tips.",
  alternates: { canonical: "/kedarnath-yatra-guide" },
  robots: { index: true, follow: true, "max-image-preview": "large" },
  openGraph: {
    title: "Kedarnath Yatra Guide: Route, Best Time & Travel Tips | On A Trip Holidays",
    description: "A practical Kedarnath Yatra guide covering route planning, accommodation, weather, walking and preparation tips.",
    url: "/kedarnath-yatra-guide",
