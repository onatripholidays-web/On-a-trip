...
export const metadata: Metadata = {
  title: "Spiti Valley Travel Guide: Route, Best Time & Packing | On A Trip Holidays",
  description: "Plan a Spiti road trip with Kaza, Tabo, Key Monastery, villages, route options, weather and packing guidance.",
  alternates: { canonical: "/spiti-valley-travel-guide" },
  robots: { index: true, follow: true, "max-image-preview": "large" },
  openGraph: {
    title: "Spiti Valley Travel Guide: Route, Best Time & Packing | On A Trip Holidays",
    description: "Plan a Spiti road trip with Kaza, Tabo, Key Monastery, villages, route options, weather and packing guidance.",
    url: "/spiti-valley-travel-guide",
